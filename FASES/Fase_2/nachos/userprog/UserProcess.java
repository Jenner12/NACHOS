...
public class UserProcess {
    ...
    private int processMemoryAccessData(byte[] data, int virtualAddress, int offset, int fullAccessSize, boolean reading){
    ...
    private boolean load(String name, String[] args) {
        ...
        pageTable = ((UserKernel) Kernel.kernel).fillPhysicalPages(numPages);
    ...
    protected void unloadSections() {
        ((UserKernel) Kernel.kernel).freeFilledPhysicalPages(pageTable);
    }    
    ...
    private static class Child{
        ...
        public Child(int pid, UserProcess parent){
            this.pid = pid;
    ...
    */
    ...
    private static class RunningFile{

        private int cantRunning;
    ...
    private boolean verifyFileDescriptor(int fd){
    ...
    private boolean verifyVirtualAddress(int virtualAddress){
   ...
   /**
    ...
    private int openOrCreateFile(int name, boolean open){
    ...
    private int handleRead(int fd, int buff, int cant) {
    ...
    private int handleWrite(int fd, int buff, int cant) {
        if (!verifyFileDescriptor(fd)){
    ...
    private static final char dbgProcessSyscalls = 'h';

    private static final int pageSize = Processor.pageSize;
    private static final int maximumFileNameLength = 256;
    private static final int maximumOpenFiles = 16;
    private static final int ROOT_PID = 1;
    
    private static Lock readingLock = new Lock();
    private static Lock writingLock = new Lock();
    private static Lock accesingMemoryLock = new Lock();
    private static Lock flagsLock = new Lock();

    private static int createdProcesses = 0;
    private static int currentlyRunningProcesses = 0;
    private static HashMap<String, RunningFile> runningFiles
                        = new HashMap<String, RunningFile>();;
    


    private OpenFile[] openFilesTable;
    private LinkedList<UserProcess> childrenProcesses;
    private UserProcess parentProcess;
    private String fileName;
    private int pid;
    private Integer exitStatus;
    private UThread thread;
    private Lock lockForParent;
    private Condition2 waitingParentCondition;
}

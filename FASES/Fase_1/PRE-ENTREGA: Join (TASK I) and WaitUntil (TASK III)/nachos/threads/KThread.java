...
public class KThread {
    ...
    */
    ...
    public static void selfTest() {
    	...
    	KThread kt1 = new KThread(new Join_And_WaitUntil_Test(6)).setName("KThread1");
        kt1.fork();
        kt1.join();
        //System.out.println("KThread1 termino de ejecutar!");
        //int segundos = 5;
        //System.out.println("Empieza waitUntilSeconds("+x+")");
        //long comienzo = System.currentTimeMillis();
        //waitUntilSeconds(segundos);
        //long fin = System.currentTimeMillis();
        //System.out.println("Termino waitUntil("+x+")");
        //System.out.println("WaitUntil tardo: " + (fin - comienzo) + " milisegundos");
    }

...
public class KThread {
    ...
    */
    ...
    public void setThreadJoinedTo(KThread t){
        this.threadJoinedTo = t;
    }

    public KThread getThreadJoinedTo(){
        return this.threadJoinedTo;
    }
    ...
    public void join() {
        ...
        if(this.status == statusFinished){
            ...
            currentThread.setThreadJoinedTo(this);
            currentThread.sleep();
            Machine.interrupt().restore(intStatus);
        }
    }
    ...
    public static void selfTest() {
        ...
        new PingTest(0).run();
        */
        //NachosFase1Test.testAllTasks();z
    ...
    private KThread threadJoinedTo;
    /**
